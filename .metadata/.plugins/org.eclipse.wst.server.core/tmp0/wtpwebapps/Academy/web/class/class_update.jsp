...
<body>
	...
	<div style="padding-left: 16px">
		...
		<p>Update class details in the database</p>
	</div>
	...
	<div style="padding-left: 16px">
		...
		%>
		<form action="../../AcademyClassServlet?action=doUpdate"
			method="get">
			<input type="hidden" name="action" value="doUpdate"> <input
				type="hidden" name="class_id"
				value=<%out.print(request.getParameter("class_id"));%>>
				

			<table>
				<tr>
					<th>Class name</th>
					<th><input type="text" required name="class_name"
						value=<%out.print(request.getParameter("class_name"));%>></th>
				</tr>
