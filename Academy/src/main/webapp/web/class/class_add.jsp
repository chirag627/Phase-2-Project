...
<body>
	...
	<div style="padding-left: 16px">
		...
		<p>Add a new Class in the database</p>
	</div>
	...
	<div style="padding-left: 16px">
		...
		%>
		<form action="../../AcademyClassServlet?action=doWrite" method="get">
			<input type="hidden" name="action" value="doWrite">
			<table>
				<tr>
					<th>Class name</th>
					<th><input type="text" name="class_name"
						placeholder="Class name"></th>
				</tr>
